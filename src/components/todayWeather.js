...
const Today = (props) => {
    ...
    return (
        ...
        <div className="p-5 flex flex-row rounded-lg backdrop-filter backdrop-blur-xl backdrop-brightness-50 md:p-10 md:w-60">
            <div className="w-50">
            ...
            <div className="w-50 md:w-50 md:flex-col">
